...
describe("buildShadowTriangles", () => {
  ...
  it("interpolates to the analytic shadow ceiling across the whole footprint", () => {
    ...
    // still shadows there — `heightM - distance * tan(altitude)`. Per-vertex weights
...
describe("pointInPrismShadow", () => {
  ...
  it("shadows a point between the building and the end of its shadow", () => {
  ...
  it("reports a point on the roof as sunlit, not shadowed", () => {
